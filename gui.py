...
class HelloFrame(wx.Frame):
    ...
    def __init__(self,*args,**kw):
        ...
        self.pnl = pnl
        st = wx.StaticText(pnl, label="形状识别", pos=(200, 0))
        font = st.GetFont()
        font.PointSize += 10
        font = font.Bold()
        st.SetFont(font)
        ...
        self.SetStatusText("Welcome to Shape world")
    ...
    def OnSelect(self, event):
        ...
        if dialog.ShowModal() == wx.ID_OK:
            ...
            shapes = ['rec', 'tri', 'cir']
            result_text = wx.StaticText(self.pnl, label=shapes[result], pos=(320, 0))
...
if __name__ == '__main__':
    app = wx.App()
    frm = HelloFrame(None, title='Shape wolrd', size=(1000,600))
    frm.Show()
    app.MainLoop()